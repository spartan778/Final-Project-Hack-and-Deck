// Referenced and modified official Godot Signaling-RTC demo at https://github.com/godotengine/godot-demo-projects under MIT license
...
wss.on("connection", (ws) => {
    ...
    ws.on("message", (msg) => {
        ...
        if (!roomName) {
            ...
            if (playerCount === 2 && !roomRef.matchReadySent) { // Send ready message when both players joined
